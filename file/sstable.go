...
//
// Licensed under the Apache License, MagicVersion 2.0 (the "License")
// you may not use this osFile except in compliance with the License.
...
func OpenSStable(opt *osFile.FileOption) *SSTable {
	omf, err := osFile.OpenMmapFile(opt.FileName, os.O_CREATE|os.O_RDWR, opt.MaxSz)
	utils.PrintErr(err)
